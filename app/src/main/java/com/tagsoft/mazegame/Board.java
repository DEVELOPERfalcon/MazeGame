...
public class Board extends View {
    ...
    private void setStars(Stars stars){
        star1 = cells[stars.star1Row][stars.star1Col];
        star2 = cells[stars.star2Row][stars.star2Col];
        star3 = cells[stars.star3Row][stars.star3Col];
    }
